            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-md-3">
                    ...
                    <?php
                            ...
                            ?>
                                <li><a class="" href="index.php?action=sanpham&act=<?php echo $set['maloai']; ?>"><?php echo $set['tenloai']; ?></a></li>
                            <?php endwhile; ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-sm-6 col-xs-12">
                    <p class="copyright-text text-secondary ">Copyright &copy; 2017 All Rights Reserved by
                        <a href="#">Scanfcode</a>.
                    </p>
                </div>
